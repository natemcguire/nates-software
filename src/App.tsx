...
function AppInner() {
  ...
  if (route.type === 'standalone_app' && route.id) {
    ...
    const isAppActive = resolvedApp.deploymentState === 'active' || (
      (resolvedApp.id === 'dronehunter' || resolvedApp.id === 'certified-mailer' || resolvedApp.id === 'wallart') && (resolvedApp as any).isDemo
    );
